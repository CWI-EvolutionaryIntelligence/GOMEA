...
void Config::parseParameters( int argc, char **argv, int *index )
{
    ...
    if(black_box_evaluations){
        switch(problem_index){
            case 0:
                fitness = std::shared_ptr<fitness_t<double>>(new fitness::sphereFunctionBBO_t(number_of_variables,vtr));
                break;
            case 1:
                fitness = std::shared_ptr<fitness_t<double>>(new fitness::rosenbrockFunctionBBO_t(number_of_variables,vtr));
                break;
            case 2:
                fitness = std::shared_ptr<fitness_t<double>>(new fitness::SOREBChainStrongBBO_t(number_of_variables,vtr));
                break;
            case 10:
                fitness = std::shared_ptr<fitness_t<double>>(new fitness::circlesInASquareBBO_t(number_of_variables,vtr));
                break;
            default:
        ...
        switch(problem_index){
            case 0:
                fitness = std::shared_ptr<fitness_t<double>>(new fitness::sphereFunction_t(number_of_variables,vtr));
                break;
            case 1:
                fitness = std::shared_ptr<fitness_t<double>>(new fitness::rosenbrockFunction_t(number_of_variables,vtr));
                break;
            case 2:
                fitness = std::shared_ptr<fitness_t<double>>(new fitness::SOREBChainStrong_t(number_of_variables,vtr));
                break;
            default:
                throw std::invalid_argument("Invalid problem index.");
        }
