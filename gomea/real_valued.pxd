...
cdef extern from "src/real_valued/config.hpp" namespace "gomea::realvalued":
    cdef cppclass config_t:
        ...
        double lower_user_range, upper_user_range, tau, distribution_multiplier_decrease, distribution_multiplier_increase, st_dev_ratio_threshold, fitness_variance_tolerance, maximum_number_of_evaluations, maximum_number_of_seconds 
