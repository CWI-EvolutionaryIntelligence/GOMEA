...
cdef public double gomea_pyfitness_mapping_function(obj, int objective_index, vector[double] &fitness_buffers ) except +:
    fitness_obj = <PythonFitnessFunction?>obj
...
cdef public double gomea_pyfitness_mapping_function_constraint_value(obj, vector[double] &fitness_buffers ) except +:
    fitness_obj = <PythonFitnessFunction?>obj
