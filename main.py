...
#lm = gomea.linkage.LinkageTree(filtered=False,similarity_measure=5,maximum_set_size=10)
lm = gomea.linkage.UCondHG()
#lm = gomea.linkage.FromFile("FOS.in")
#lm = gomea.linkage.Full()
rvgom = gomea.RealValuedGOMEA(fitness=frv,linkage_model=lm,lower_init_range=-115,upper_init_range=-100,random_seed=100, maximum_number_of_populations=1, base_population_size=40)
result = rvgom.run()
