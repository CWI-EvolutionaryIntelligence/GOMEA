...
class YourPythonFitnessFunction(Fitness.PythonFitnessFunction):
...
#f = Fitness.YourFitnessFunction(10000,value_to_reach=1e-10)
f = YourPythonFitnessFunction(10000,value_to_reach=1e-10)
